...
export class WebhookController {
     ...
     */
    handleVoiceWebhook = async (req: Request, res: Response): Promise<void> => {
        ...
        try {
            ...
            if (direction === 'outbound' && callId) {
                ...
                const toNumber = req.query.toNumber as string || To;
     ...
     */
    handleRecordingWebhook = async (req: Request, res: Response): Promise<void> => {
        ...
        try {
            ...
            const recording = this.callService.handleRecordingReady(
                ...
                parseInt(RecordingChannels || '1', 10)
            );
     ...
     */
    handleTranscriptionWebhook = async (req: Request, res: Response): Promise<void> => {
     ...
     */
    handleFallback = async (req: Request, res: Response): Promise<void> => {
