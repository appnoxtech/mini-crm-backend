...
export function createCallRoutes(callController: CallController): Router {
     ...
     */
    router.post('/token', authMiddleware, callController.generateToken);
     ...
     */
    router.get('/stats', authMiddleware, callController.getStats);
     ...
     */
    router.get('/contact/:contactId', authMiddleware, callController.getCallsForContact);
     ...
     * Response: { calls: CallWithDetails[] }
     */
    router.get('/deal/:dealId', authMiddleware, callController.getCallsForDeal);
     ...
     */
    router.get('/:id', authMiddleware, callController.getCall);
     ...
     */
    router.get('/:id/recording', authMiddleware, callController.getRecording);
     ...
     * Response: Call
     */
    router.patch('/:id', authMiddleware, callController.updateCall);
     ...
     * Response: Call
     */
    router.post('/end/:id', authMiddleware, callController.endCall);
