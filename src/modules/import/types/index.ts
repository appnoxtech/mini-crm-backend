...
export type DuplicateHandling =
    ...
    | 'create'    // Create as new (allow duplicates)
    | 'error';    // Fail the entire import
...
export interface FieldMapping {
    sourceColumn: string;       // Column name from file
    targetField: string;        // CRM field name
    isRequired: boolean;
    defaultValue?: any;
    transformFunction?: string; // e.g., 'uppercase', 'lowercase', 'trim'
}
...
// Entity-specific import data interfaces
