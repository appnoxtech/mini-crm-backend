...
exports.gmailPushService = exports.GmailPushService = void 0;
...
class GmailPushService {
    ...
    WATCH_RENEWAL_INTERVAL_MS = 6 * 60 * 60 * 1000; // 6 hours (watch expires in 7 days)
    constructor() {
     ...
     */
    async processGmailChanges(watchInfo, newHistoryId) {
        ...
        try {
            ...
            if (this.notificationService) {
                this.notificationService.notifyError(watchInfo.userId, `Failed to sync Gmail: ${error.message}`, { accountId: watchInfo.accountId, accountEmail: watchInfo.email });
            }
        }
    }
    /**
     ...
     */
    async startWatchingAllAccounts(getActiveAccounts) {
        try {
...
// Singleton instance
exports.gmailPushService = new GmailPushService();
//# sourceMappingURL=gmailPushService.js.map