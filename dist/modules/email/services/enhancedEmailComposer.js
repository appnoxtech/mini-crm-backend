...
exports.EnhancedEmailComposer = void 0;
const crypto = __importStar(require("crypto"));
class EnhancedEmailComposer {
    trackingBaseUrl;
    constructor(trackingBaseUrl = process.env.TRACKING_BASE_URL || 'http://localhost:3001') {
        this.trackingBaseUrl = trackingBaseUrl;
    }
    async composeEmail(emailRequest) {
        ...
        const { htmlBody, textBody } = await this.applyPersonalizationAndTracking(processedBodyHtml, processedBodyText, messageId, emailRequest.tracking);
    ...
    async applyPersonalizationAndTracking(htmlBody, textBody, messageId, tracking) {
    ...
    wrapLinksWithTracking(htmlBody, messageId) {
    ...
    createGmailMessage(mimeMessage) {
    ...
    createMessageMetadata(messageId, request, rawMessage) {
...
exports.EnhancedEmailComposer = EnhancedEmailComposer;
//# sourceMappingURL=enhancedEmailComposer.js.map