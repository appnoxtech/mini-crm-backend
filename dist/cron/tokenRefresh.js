 ...
 */
function startTokenRefreshJob(dbPath) {
      ...
      `).all();
            ...
            for (const accountRow of accounts) {
                try {
                    ...
                    const refreshResult = await oauthService.refreshTokenIfNeeded(account);
                    if (refreshResult) {
    ...
    node_cron_1.default.schedule('0 */6 * * *', refreshAllTokens);
